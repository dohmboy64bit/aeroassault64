...
- [x] **`lib/Zelda64Recomp`** present as submodule (**`dev`**); **`git submodule update --init --recursive`** documented in **`lib/README.txt`**. **Pin:** **`b4e9a3839377f12eabecd884bf8e986ea45817e2`** (**2026-05-13**).
